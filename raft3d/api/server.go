...
func (s *Server) Start(addr string) error {
	...
	http.HandleFunc("/api/v1/printers/", s.printerHandler)
	http.HandleFunc("/api/v1/filaments", s.filamentsHandler)
	http.HandleFunc("/api/v1/filaments/", s.filamentHandler)
...
func (s *Server) printerHandler(w http.ResponseWriter, r *http.Request) {
...
func (s *Server) filamentHandler(w http.ResponseWriter, r *http.Request) {
	http.Error(w, "Not implemented", http.StatusNotImplemented)
}
